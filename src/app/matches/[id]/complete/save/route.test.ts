...
vi.mock("@/lib/supabase/route-handler", () => ({ createRouteHandlerClient: () => ({ applyAuthState: (response: Response) => response, supabase: { auth: { getClaims: async () => ({ data: { claims: { sub: "d1000000-0000-4000-8000-000000000001" } } }) } } }) }));
